...
export function BlueButtonSVG({width, height}) {
  return (
    ...
    >
      ...
      <g filter="url(#filter1_i_47_263)">
        <circle cx="92" cy="88" r="75" fill="#ADD9F4" />
      </g>
      <g filter="url(#filter2_f_47_263)">
        <ellipse
          cx="67.8336"
          cy="43.5311"
          rx="25.8188"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_47_263"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
        ...
        >
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect1_innerShadow_47_263"
          />
          <feOffset dx="-1" dy="2" />
          <feGaussianBlur stdDeviation="2" />
          <feComposite in2="hardAlpha" operator="arithmetic" k2="-1" k3="1" />
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="5"
            result="effect1_foregroundBlur_47_263"
          />
        </filter>
        <filter
          id="filter3_f_47_263"
...
export function GreenButtonSVG({width, height}) {
  return (
    <Svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g filter="url(#filter0_d_47_268)">
        <circle cx="91.5" cy="87.5" r="87.5" fill="#818181" />
      </g>
      <g filter="url(#filter1_i_47_268)">
        <circle cx="92" cy="88" r="75" fill="#299741" />
      </g>
      <g filter="url(#filter2_f_47_268)">
        <ellipse
          cx="67.8336"
          cy="43.5311"
          rx="25.8188"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_47_268"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_47_268"
            result="shape"
          />
        </filter>
        <filter
        ...
        >
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect1_innerShadow_47_268"
          />
          <feOffset dx="-1" dy="2" />
          <feGaussianBlur stdDeviation="2" />
          <feComposite in2="hardAlpha" operator="arithmetic" k2="-1" k3="1" />
        ...
        >
          ...
          <feGaussianBlur
            stdDeviation="5"
            result="effect1_foregroundBlur_47_268"
          />
        </filter>
        <filter
          id="filter3_f_47_268"
