export const level1Data = {
  text: [
    ...
    /*1*/ "But to late. A splash and the muddy waters close over your head. And then you begin to drop. You have been diving before. The familiar feeling overtakes you as you slowly descend.",
    ...
    /*3*/ "You are about to panic, but before the fear can wash over you, you hit the ground. To fast. The ocean should be way deeper here. Or... Were you dragged down so fast, that what should have taken minutes is over in seconds?",
